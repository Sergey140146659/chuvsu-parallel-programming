...
Для сборки и запуска `task29.cpp` используйте следующие команды:

```bash
mpic++ -std=c++20 task29.cpp -o task29
export FI_PROVIDER=tcp
mpirun -n 4 ./task29
```

**Результаты эксперимента (зависимость времени от N и количества процессов):**

| № | Программа | Параметр N | Количество процессов | Время выполнения (сек.) |
|---|----------|------------|----------------------|--------------------------|
| 57 | Число π   | 100        | 1  | 0.000004 |
| 58 | Число π   | 10000000   | 1  | 0.015938 |
| 59 | Число π   | 4000000000 | 1  | 6.043668 |
| 60 | Число π   | 100        | 2  | 0.001394 |
| 61 | Число π   | 10000000   | 2  | 0.008609 |
| 62 | Число π   | 4000000000 | 2  | 3.108078 |
| 63 | Число π   | 100        | 4  | 0.000812 |
| 64 | Число π   | 10000000   | 4  | 0.004271 |
| 65 | Число π   | 4000000000 | 4  | 1.716508 |
| 66 | Число π   | 100        | 6  | 0.000774 |
| 67 | Число π   | 10000000   | 6  | 0.003347 |
| 68 | Число π   | 4000000000 | 6  | 1.562226 |
| 69 | Число π   | 100        | 8  | 0.001074 |
| 70 | Число π   | 10000000   | 8  | 0.005193 |
| 71 | Число π   | 4000000000 | 8  | 1.667727 |
| 72 | Число π   | 100        | 10 | 0.001236 |
| 73 | Число π   | 10000000   | 10 | 0.003158 |
| 74 | Число π   | 4000000000 | 10 | 1.471476 |
| 75 | Число π   | 100        | 12 | 0.001696 |
| 76 | Число π   | 10000000   | 12 | 0.003373 |
| 77 | Число π   | 4000000000 | 12 | 1.464194 |
